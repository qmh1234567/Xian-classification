...
from transform import mixup_data
from transform import mixip_criterion
...
def create_pretrained_model(args):
    ...
    if args.pretrained:
        ...
        if not mox.file.exists('../pre-trained_model/pytorch/resnext101_32x8d-8ba56ff5.pth'):
            mox.file.copy('s3://xianbucket/resnext101_32x8d-8ba56ff5.pth',
                          '../pre-trained_model/pytorch/resnext101_32x8d-8ba56ff5.pth')
...
def create_model(args):
    ...
    # resnet = create_pretrained_model(args)
    # model = resnet_model_cbam.resnext101_32x8d()
