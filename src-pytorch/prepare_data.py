...
'''
python prepare_data.py --input_dir './../train_data1' --output_train_dir './datasets/train_val/train' --output_val_dir './datasets/train_val/val'
...
def prepare_data_on_modelarts(args):
    ...
    if not os.path.exists(args.local_data_root):
        os.mkdir(args.local_data_root)
