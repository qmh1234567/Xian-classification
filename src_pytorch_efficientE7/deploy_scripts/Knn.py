...
# # 测试
# def infer_on_dataset(test_dir, model_path,pca):
...
#             error_results.append(','.join([files[index],true_label,pred_label])+'\n')
...
#     train_y = 'y_train.py'
#     # 构造训练数据
#     x_train,y_train = generate_train_dataset(val_npy_path)
